...
export default function UsagePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {totalReqs === 0 ? (
        <EmptyState message="No gateway traffic yet. Requests routed through APIShield will appear here." />
      ) : (
        <>
          {/* Overview Cards */}
            ...
            <div className="card bg-[#161b22] border-white/10 flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold font-mono text-green-400 mt-1">
                  {(overview?.successfulRequests || 0).toLocaleString()}
                </p>
              </div>
            ...
            <div className="card bg-[#161b22] border-white/10 flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold font-mono text-red-400 mt-1">
                  {(overview?.failedRequests || 0).toLocaleString()}
                </p>
              </div>
