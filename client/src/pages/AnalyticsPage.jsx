...
import { BarChart3, TrendingUp, Key, Users, Globe, Code, FileText } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="card space-y-4">
          ...
          {requestsByEnvironment.length === 0 ? (
            ...
            <div className="space-y-2">
              {requestsByEnvironment.map((item) => (
                <div key={item.environment} className="flex items-center justify-between text-xs">
                  <Badge variant="purple">{item.environment}</Badge>
                  <span className="font-mono text-gray-300 font-semibold">{item.requests} reqs</span>
                </div>
              ))}
            </div>
